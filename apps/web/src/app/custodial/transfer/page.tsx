  ...
  if (!claimId || !token) {
    return (
      <div className="min-h-[calc(100vh-4rem)] flex flex-col items-center justify-center px-4 py-16 text-center">
        ...
        <h2 className="text-xl font-black text-white mb-2">Missing transfer details</h2>
        <p className="text-gray-400 max-w-md">
          Open the transfer link from your purchase confirmation email or the success page.
        </p>
        <Link href="/presale" className="mt-6 text-malama-accent font-bold hover:underline">
          ← Back to Presale
        </Link>
      </div>
    )
    ...
    return (
      <div className="min-h-[calc(100vh-4rem)] flex flex-col items-center justify-center px-4 py-16 max-w-md mx-auto text-center">
        ...
        <p className="text-gray-400 text-sm mb-6">
          Your Genesis Hex Node License NFT was sent to the wallet you specified.
        </p>
        {explorerUrl && (
          <a
            href={explorerUrl}
        ...
        <Link href="/dashboard" className="mt-10 text-gray-500 hover:text-malama-accent text-sm">
          ← Node Command Center
        </Link>
      </div>
    )
  ...
  return (
    <div className="min-h-[calc(100vh-4rem)] flex flex-col items-center px-4 py-16 max-w-md mx-auto">
      ...
      <p className="text-gray-400 text-sm text-center mb-2">
        Claim <span className="font-mono text-malama-accent">{claimId}</span>
      </p>
      <p className="text-gray-500 text-sm text-center mb-8">
        Enter the MetaMask or other Base wallet address where you want your Genesis Hex Node License NFT.
        Gas is paid from the custodial wallet — you pay nothing.
      </p>
      ...
      >
        ...
        {loading ? 'Transferring…' : 'Send NFT to my wallet'}
      </button>

      <p className="text-xs text-gray-600 mt-6 text-center leading-relaxed">
        This page is authenticated by the secret token in your URL. Do not share this link publicly.
      </p>
