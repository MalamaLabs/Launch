...
// Temporarily disable Cardano wallet here
// import { useWallet as useCardanoWallet } from '@sidan-lab/sidan-csl-rs-nodejs';
import dynamic from 'next/dynamic';
import { Server, ShieldCheck, Cpu } from 'lucide-react';

const NodeStatus = dynamic(() => import('@/components/NodeStatus'), { ssr: false });

export default function DashboardPage() {
  // TEMP STUB: always treat as connected for now
  const connected = true;
  // If you want to show the “Access Denied” screen, set this to false.
      ...
      <div className="w-full min-h-[calc(100vh-4rem)] flex flex-col items-center justify-center bg-malama-deep px-4 relative overflow-hidden text-center">
        ...
        <div className="relative z-10 flex flex-col items-center">
          ...
          <h1 className="text-5xl md:text-7xl font-black text-white mb-6 tracking-tighter drop-shadow-xl">
            Global Hardware <br />
            <span className="text-malama-teal">Access Denied</span>
          </h1>
    ...
    <div className="w-full min-h-[calc(100vh-4rem)] bg-malama-deep px-4 py-16 md:py-24 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto space-y-16 relative z-10">
        <header className="flex flex-col md:flex-row md:items-end justify-between border-b border-gray-800 pb-10">
          <div>
            <h1 className="text-6xl font-black text-white mb-4 flex items-center tracking-tight drop-shadow-lg">
              <Server className="w-12 h-12 mr-6 text-malama-teal" /> Command Center
            </h1>
            <p className="text-xl text-gray-400 max-w-3xl leading-relaxed">
              Supervise, authenticate, and systematically administer your physical Genesis element networks actively verifying native Cardano hashes continuously.
            </p>
          </div>
