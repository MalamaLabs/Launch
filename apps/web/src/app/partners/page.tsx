...
import {
  ArrowRight, Share2, DollarSign, Zap, Users, CheckCircle2,
} from 'lucide-react'
  ...
  return (
    <div className="min-h-screen bg-malama-bg">
      ...
      <section className="max-w-5xl mx-auto px-6 py-20">
        ...
        <motion.h2 initial="hidden" animate="show" variants={fadeUp} custom={1}
          className="text-3xl font-serif font-black text-white mb-12">
          Three steps to your first payout
        </motion.h2>
        <div className="grid md:grid-cols-3 gap-6">
          {HOW_IT_WORKS.map((item, i) => (
            <motion.div key={item.step} initial="hidden" animate="show" variants={fadeUp} custom={i + 2}
      ...
      <section className="max-w-5xl mx-auto px-6 pb-20">
        ...
        <div className="grid md:grid-cols-3 gap-5">
          {TIERS.map((tier, i) => (
            <motion.div key={tier.label} initial="hidden" animate="show" variants={fadeUp} custom={i + 2}
              ...
              <p className="text-malama-ink-dim text-sm mb-3">
                per sale · <span className="text-malama-accent font-mono">{tier.usd}</span> per node
              </p>
        ...
        <div className="max-w-5xl mx-auto px-6 py-16 grid md:grid-cols-2 gap-10">
          {[
            ...
            },
            {
              ...
              a: 'No. Refer as many buyers as you like. The 200 Genesis nodes are the only natural limit.',
            },
            {
              q: 'How long does the cookie last?',
              a: '30 days from first click. If someone returns and buys within 30 days, you earn the commission.',
            },
            {
